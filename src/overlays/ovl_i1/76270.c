...
s32 func_i1_804073F4(u16 arg0, u8* arg1, u8* arg2, s32 arg3, u32 arg4, s32 arg5, s32 arg6, s32 arg7) {
    ...
    if (sp2E != 0xFFFF) {
        D_i1_804286E0 = D_i1_8041B550[sp2E].unk_2A;
        if (D_i1_8041B550[sp2E].unk_00 & 0x2000) {
            D_i1_80428610 = 0x106;
            return -1;
        }
...
s32 func_i1_804078C8(u16 arg0, u8* arg1, u32 arg2, s32 arg3) {
    ...
    sp34 = D_i1_8041B550[arg0].unk_0A;
    func_i1_80408B90();
    func_i1_80408D94(&sp34, sp44, &sp3C);
    if (sp3C != 0) {
        func_i1_8040D530(sp34 + D_i1_80428638, 1, &sp38);
...
s32 func_i1_80407B90(u16 arg0, s32 arg1, s32 arg2) {
    ...
    sp2C = D_i1_8041B550[arg0].unk_0C + arg2;

    func_i1_80408B90();
    func_i1_80408CDC(D_i1_8041B550[arg0].unk_0A);
    if (func_i1_80404A08() < sp2C) {
        func_i1_804040EC();
        D_i1_80428610 = 0xF1;
        return -1;
    }
    sp28 = D_i1_8041B550[arg0].unk_00;
...
s32 func_i1_80407F48(u16 arg0, u8* arg1, s32 arg2, u32 arg3, s32 arg4) {
    ...
    if (sp44 != 0) {
        func_i1_8040D530(sp3C + D_i1_80428638, 1, &sp40);
    ...
    while (sp48 != 0) {
        ...
        for (sp2C = 1; sp2C <= sp30; sp2C++) {
            func_i1_8040D530(sp3C + D_i1_80428638, sp2C, &sp40);
            if (sp40 >= sp48) {
                break;
            }
        }
...
s32 func_i1_804083C8(u16 arg0, s32 arg1, u32 arg2, u32 arg3) {
    ...
    if (D_i1_8041B550[arg0].unk_0C < arg2 + arg3) {
        D_i1_80428610 = 0xF4;
        return -1;
    }
    sp2C = D_i1_8041B550[arg0].unk_00;
...
s32 func_i1_80408754(u16 arg0, s32 arg1, u32 arg2, u32 arg3) {
    ...
    if (D_i1_8041B550[arg0].unk_0C < arg2 + arg3) {
        sp30 = D_i1_8041B550[arg0].unk_0C - arg2;
        sp2C = (arg2 + arg3) - D_i1_8041B550[arg0].unk_0C;
    } else {
        sp30 = arg3;
    }
    sp34 = D_i1_8041B550[arg0].unk_00;
