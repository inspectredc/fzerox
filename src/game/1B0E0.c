...
unk_800CF1B0 D_800CF1B0[] = {
    { 0, 0, 0, { 0, 211, 0, 77 }, { 0, 0, 87, 77 }, { 255, 102, 48, 77 }, 7, { 1, 2, 1 }, 1260 },                // CAPTAIN_FALCON
    { 0, 1, 1, { 255, 226, 43, 120 }, { 205, 255, 133, 80 }, { 25, 255, 255, 160 }, 3, { 3, 0, 3 }, 1420 },      // DR_STEWART
    { 0, 2, 2, { 0, 75, 190, 100 }, { 134, 81, 65, 100 }, { 73, 163, 16, 100 }, 6, { 1, 1, 2 }, 1620 },          // PICO
    { 0, 3, 3, { 245, 52, 72, 43 }, { 72, 52, 121, 120 }, { 146, 52, 245, 65 }, 5, { 0, 3, 1 }, 1960 },          // SAMURAI_GOROH
    { 0, 4, 4, { 111, 255, 0, 255 }, { 79, 0, 182, 168 }, { 184, 0, 133, 0 }, 2, { 2, 2, 0 }, 1150 },            // JODY_SUMMER
    { 0, 5, 5, { 255, 0, 74, 36 }, { 0, 0, 74, 101 }, { 0, 190, 74, 46 }, 1, { 4, 0, 2 }, 1330 },                // MIGHTY_GAZELLE
    { 0, 6, 6, { 143, 255, 77, 57 }, { 73, 104, 198, 188 }, { 232, 3, 216, 35 }, 9, { 4, 0, 3 }, 1870 },         // MR_EAD
    { 0, 7, 7, { 143, 60, 146, 220 }, { 144, 60, 216, 220 }, { 192, 60, 146, 146 }, 4, { 1, 3, 0 }, 1780 },      // BABA
    { 0, 8, 8, { 146, 255, 14, 44 }, { 0, 108, 75, 148 }, { 17, 0, 26, 196 }, 8, { 1, 1, 2 }, 990 },             // OCTOMAN
    { 0, 9, 9, { 100, 240, 239, 92 }, { 100, 201, 98, 184 }, { 100, 64, 195, 227 }, 22, { 4, 0, 2 }, 780 },      // GOMAR_AND_SHIOH
    { 0, 10, 10, { 71, 255, 58, 99 }, { 202, 240, 58, 223 }, { 196, 0, 58, 102 }, 12, { 1, 2, 1 }, 1010 },       // KATE_ALEN
    { 0, 11, 11, { 0, 196, 20, 121 }, { 90, 33, 41, 101 }, { 90, 33, 121, 20 }, 28, { 4, 1, 1 }, 1780 },         // ROGER_BUSTER
    { 0, 12, 12, { 160, 255, 223, 123 }, { 160, 168, 112, 251 }, { 180, 0, 255, 255 }, 10, { 4, 1, 1 }, 1390 },  // JAMES_MCCLOUD
    { 0, 13, 13, { 71, 255, 255, 150 }, { 79, 198, 84, 150 }, { 151, 0, 144, 150 }, 19, { 2, 2, 0 }, 910 },      // LEON
    { 0, 14, 14, { 10, 53, 255, 92 }, { 50, 201, 240, 238 }, { 20, 255, 0, 63 }, 17, { 0, 1, 3 }, 2060 },        // ANTONIO_GUSTER
    { 0, 15, 15, { 30, 54, 82, 122 }, { 30, 35, 54, 107 }, { 30, 192, 82, 14 }, 30, { 0, 4, 0 }, 2340 },         // BLACK_SHADOW
    { 0, 16, 16, { 206, 25, 249, 22 }, { 84, 168, 218, 217 }, { 22, 29, 3, 174 }, 24, { 0, 2, 2 }, 2110 },       // MICHAEL_CHAIN
    { 0, 17, 17, { 71, 255, 28, 56 }, { 79, 0, 80, 56 }, { 151, 0, 42, 56 }, 14, { 1, 3, 0 }, 1050 },            // JACK_LEVIN
    { 0, 18, 18, { 141, 29, 46, 38 }, { 15, 21, 46, 130 }, { 36, 184, 46, 29 }, 20, { 4, 1, 1 }, 860 },          // SUPER_ARROW
    { 0, 19, 19, { 141, 29, 46, 38 }, { 15, 21, 46, 130 }, { 36, 184, 46, 29 }, 21, { 4, 1, 1 }, 1140 },         // MRS_ARROW
    { 0, 20, 20, { 14, 200, 213, 22 }, { 145, 51, 14, 95 }, { 213, 195, 14, 38 }, 26, { 3, 0, 3 }, 900 },        // JOHN_TANAKA
    { 0, 21, 21, { 19, 190, 165, 20 }, { 64, 190, 12, 60 }, { 90, 190, 12, 20 }, 18, { 2, 2, 0 }, 1460 },        // BEASTMAN
    { 0, 22, 22, { 26, 219, 217, 155 }, { 30, 230, 0, 24 }, { 57, 255, 0, 156 }, 13, { 4, 0, 2 }, 1620 },        // ZODA
    { 0, 23, 23, { 203, 121, 255, 255 }, { 203, 205, 255, 149 }, { 84, 212, 255, 244 }, 29, { 0, 1, 4 }, 2220 }, // DR_CLASH
    { 0, 24, 24, { 3, 218, 28, 118 }, { 3, 17, 181, 118 }, { 46, 17, 104, 118 }, 23, { 1, 0, 4 }, 1530 },        // SILVER_NEELSEN
    { 0, 25, 25, { 51, 203, 0, 9 }, { 48, 0, 126, 131 }, { 28, 0, 20, 166 }, 15, { 1, 3, 0 }, 1520 },            // BIO_REX
    { 0, 26, 26, { 72, 21, 179, 69 }, { 90, 120, 49, 72 }, { 0, 149, 67, 137 }, 27, { 2, 0, 3 }, 950 },          // DRAQ
    { 0, 27, 27, { 254, 227, 20, 104 }, { 244, 62, 72, 99 }, { 65, 34, 24, 150 }, 11, { 1, 1, 2 }, 1490 },       // BILLY
    { 0, 28, 28, { 31, 232, 192, 91 }, { 63, 0, 0, 91 }, { 223, 0, 176, 91 }, 16, { 2, 0, 3 }, 1010 },           // THE_SKULL
    { 0, 29, 29, { 200, 0, 63, 40 }, { 0, 72, 214, 38 }, { 0, 255, 42, 105 }, 25, { 1, 0, 4 }, 1170 },           // BLOOD_FALCON
    { 2, 0, 0, { 223, 34, 12, 224 }, { 199, 34, 50, 239 }, { 33, 34, 109, 240 }, 7, { 0, 1, 0 }, 790 },
    { 3, 3, 3, { 55, 42, 85, 10 }, { 55, 59, 11, 123 }, { 55, 136, 24, 125 }, 5, { 1, 0, 0 }, 2210 },
    { 4, 4, 4, { 33, 42, 0, 134 }, { 55, 42, 134, 0 }, { 137, 42, 73, 72 }, 2, { 0, 0, 1 }, 1840 },
};
// clang-format on
...
void func_80085B80(unk_struct_1DC* arg0, unk_struct_F8* arg1, unk_800E5D70* arg2) {
    ...
    switch (arg0->unk_04) {
        ...
        case 8:
            ...
            racer = &gRacers[arg0->unk_00];
            func_80088408(&D_800E5E90[arg0->unk_00], racer->unk_0C.unk_00, racer->unk_0C.unk_04, &D_800CD970[0]);
            break;
        case 9:
            racer = &gRacers[arg0->unk_00];
...
void func_80088D28(void) {
    ...
    var_s2 = gCurrentCourseRecordInfo->unk_10->prev;
    var_fs0 = 1.0f;
    for (i = 20; i > 0; i--) {
...
void func_80089A74(CarInfo* arg0) {
    ...
    arg0->unk_00[0] = gRacers[0].character;
    arg0->unk_00[8] = (s32) gRacers[0].unk_2E0;
    arg0->unk_00[9] = (s32) gRacers[0].unk_2E4;
    arg0->unk_00[10] = (s32) gRacers[0].unk_2E8;
    arg0->unk_00[1] = var_v0 = gRacers[0].unk_167;
    if (var_v0 == 1) {
        temp_v0 = D_800F8360[gRacers[0].character];
        arg0->unk_00[2] = temp_v0[0];
        arg0->unk_00[3] = temp_v0[1];
        arg0->unk_00[4] = temp_v0[2];
        arg0->unk_00[5] = temp_v0[3];
        arg0->unk_00[6] = D_800F80C8[gRacers[0].character].unk_10 - 1;
        arg0->unk_00[7] = temp_v0[4];
        arg0->unk_00[11] = temp_v0[5];
        arg0->unk_00[12] = temp_v0[6];
        arg0->unk_00[13] = temp_v0[7];
        arg0->unk_00[14] = temp_v0[8];
        arg0->unk_00[15] = temp_v0[9];
        arg0->unk_00[16] = temp_v0[10];
        arg0->unk_00[17] = temp_v0[11];
        arg0->unk_00[18] = temp_v0[12];
        arg0->unk_00[19] = temp_v0[13];
    } else {
        arg0->unk_00[2] = arg0->unk_00[3] = arg0->unk_00[4] = arg0->unk_00[5] = arg0->unk_00[6] = arg0->unk_00[7] =
            arg0->unk_00[11] = arg0->unk_00[12] = arg0->unk_00[13] = arg0->unk_00[14] = arg0->unk_00[15] =
                arg0->unk_00[16] = arg0->unk_00[17] = arg0->unk_00[18] = arg0->unk_00[19] = 0;
    }
}
    ...
    for (var_s0 = D_800E5EC4; var_s0 >= gRacers; var_s0--) {
        ...
        if (var_s0->unk_04 & 0x8000000) {
            ...
            var_s0->raceTime = (s32) (((var_s0->raceTime - var_a1) * gTotalLapCount) *
                                      gCurrentCourseRecordInfo->unk_0C / var_s0->unk_23C) +
                               var_a1;
...
void func_8008AD38(void) {
    ...
    if (D_800E5EC0 < 2) {
        ...
        gRacers[0].unk_2C0 = gRacers[0].unk_2C4 = gCurrentCourseRecordInfo->unk_0C;
        return;
    }

    temp_fv0 = gCurrentCourseRecordInfo->unk_0C * 0.5f;
        ...
        do {
            ...
            if (temp_fv1 < 0.0f) {
                ...
                if (temp_fv1 < temp_fv0) {
                    ...
                    var_v1->unk_0C = gCurrentCourseRecordInfo->unk_0C - temp_fv1;
                } else {
                    var_v1->unk_00 = var_a1;
                    var_v1->unk_04 = var_a0;
                    var_v1->unk_08 = gCurrentCourseRecordInfo->unk_0C - temp_fv1;
    ...
    var_fv0 = gCurrentCourseRecordInfo->unk_0C + 10.0f;
...
void func_8008B150(void) {
    ...
    var_fv0 = gCurrentCourseRecordInfo->unk_0C;
...
f32 func_8008B2D8(Racer* arg0, f32 arg1) {
    ...
    arg0->unk_1F8 = D_800CF188[temp_a1->machineStats[2]] + ((temp_fv1 - temp_fv0) * arg1) + temp_fv0;
    ...
    arg0->unk_1FC = D_800CF19C[temp_a1->machineStats[2]] + ((temp_fv1 - temp_fv0) * arg1) + temp_fv0;
    ...
    arg0->unk_1C0 = (D_800CF174[temp_a1->machineStats[1]] + temp_fa1) / arg0->unk_1B8;
...
void func_8008C14C(Racer* arg0) {
    ...
    arg0->unk_240 = -gCurrentCourseRecordInfo->unk_0C;
    arg0->unk_284 = 0;
    arg0->unk_286 = 0;
    ...
    arg0->unk_1F4 = ((4 - temp_s2->machineStats[0]) * 312.0f) + 780.0f + ((312.0f * (temp_s2->unk_14 - 780.0f)) / 1560.0f);
    ...
    arg0->unk_228 = arg0->unk_22C = D_800CF160[temp_s2->machineStats[0]];
...
void func_8008C7C8(void) {
    ...
    D_800F80BC = gCurrentCourseRecordInfo->unk_0C * 0.5;
...
void func_8008D5F4(CarInfo* arg0, s32 arg1) {
    ...
    if (arg0->unk_00[1] == 1) {
        gfx = func_i9_80161050(D_800CDD38[arg1], arg0->unk_00[5], arg0->unk_00[6], arg0->unk_00[7]);
        gSPEndDisplayList(gfx);

        for (i = 4; i >= 0; i--) {
            gfx = func_i9_80115DF0(D_800CDDB0[arg1 * 6 + i], i, arg0->unk_00[2], arg0->unk_00[3], arg0->unk_00[4],
                                   arg0->unk_00[14], arg0->unk_00[15], arg0->unk_00[16], arg0->unk_00[11],
                                   arg0->unk_00[12], arg0->unk_00[13], 255, 255, 255, arg0->unk_00[17],
                                   arg0->unk_00[18], arg0->unk_00[19]);
            gSPEndDisplayList(gfx);
        }
    ...
    if (arg0->unk_00[1] != 0) {
        var_v1 = arg0->unk_00[1] + 28;
    } else {
        var_v1 = arg0->unk_00[0];
    }
...
void func_8008D824(void) {
    ...
    for (i = 4; i >= 0; i--) {
        D_800F8504[i] = i + 1;
        func_8008D5F4(sp2C->carInfo[i].unk_00, D_800F8504[i]);
    }

    var = 5;
    D_800F8504[var] = var + 1;
    func_8008D5F4(sp2C->maxSpeedCar.unk_00, D_800F8504[var]);
    var = 6;
    D_800F8504[var] = var + 1;
    func_8008D5F4(sp2C->bestTimeCar.unk_00, D_800F8504[var]);
}
...
void func_80090BCC(Racer* arg0, Controller* arg1) {
    ...
    sp10C.x = arg0->unk_0C.unk_34.x + arg0->velocity.x;
    sp10C.y = arg0->unk_0C.unk_34.y + arg0->velocity.y;
    sp10C.z = arg0->unk_0C.unk_34.z + arg0->velocity.z;
    ...
    var_fs1 *= ((arg0->unk_C0.z.x * arg0->velocity.x) + (arg0->unk_C0.z.y * arg0->velocity.y) +
                (arg0->unk_C0.z.z * arg0->velocity.z));
    var_fs0 = ((arg0->unk_C0.y.x * arg0->velocity.x) + (arg0->unk_C0.y.y * arg0->velocity.y) +
               (arg0->unk_C0.y.z * arg0->velocity.z)) *
              0.94f;
    var_ft4 *= ((arg0->unk_C0.x.x * arg0->velocity.x) + (arg0->unk_C0.x.y * arg0->velocity.y) +
                (arg0->unk_C0.x.z * arg0->velocity.z));
    arg0->velocity.x = (arg0->unk_C0.z.x * var_fs1) + (arg0->unk_C0.y.x * var_fs0) + (arg0->unk_C0.x.x * var_ft4);
    arg0->velocity.y = (arg0->unk_C0.z.y * var_fs1) + (arg0->unk_C0.y.y * var_fs0) + (arg0->unk_C0.x.y * var_ft4);
    arg0->velocity.z = (arg0->unk_C0.z.z * var_fs1) + (arg0->unk_C0.y.z * var_fs0) + (arg0->unk_C0.x.z * var_ft4);
        ...
        if (var_v0_2 != NULL) {
            ...
            do {
                ...
                if ((SQ(var_fs1) + SQ(var_fs0) + SQ(var_ft4)) < 900.0f) {
                    arg0->acceleration.x += (15.0f * arg0->unk_B4.x);
                    arg0->acceleration.y += (15.0f * arg0->unk_B4.y);
                    arg0->acceleration.z += (15.0f * arg0->unk_B4.z);
                    arg0->unk_04 |= 0x10000;
    ...
    if (!(arg0->unk_04 & 0x200000)) {
        ...
        if (var_v0_3 != NULL) {
            ...
            do {
                ...
                arg0->unk_1DC = (arg0->speed * 0.3f) + 0.5f;
                if ((arg0->id < gNumPlayers) && (D_800E5FD0 != 0)) {
    ...
    arg0->acceleration.x += (-1.0f * arg0->unk_A8.x);
    arg0->acceleration.y += (-1.0f * arg0->unk_A8.y);
    arg0->acceleration.z += (-1.0f * arg0->unk_A8.z);
    if (arg0->unk_04 & 0x200000) {
        arg0->acceleration.x += (arg0->unk_1DC * arg0->unk_B4.x);
        arg0->acceleration.y += (arg0->unk_1DC * arg0->unk_B4.y);
        arg0->acceleration.z += (arg0->unk_1DC * arg0->unk_B4.z);
        arg0->unk_1DC *= 0.8f;
    }
    if (!(arg0->unk_04 & 0x80000000)) {
        var_fa1 = arg0->unk_17C - arg0->unk_A0;
        if (var_fa1 > 0.0f) {
            var_fa1 -= ((arg0->velocity.x * arg0->unk_19C.x) + (arg0->velocity.y * arg0->unk_19C.y) +
                        (arg0->velocity.z * arg0->unk_19C.z));

            arg0->unk_198 = var_fa1 * 0.2f;

            arg0->acceleration.x += (arg0->unk_198 * arg0->unk_19C.x);
            arg0->acceleration.y += (arg0->unk_198 * arg0->unk_19C.y);
            arg0->acceleration.z += (arg0->unk_198 * arg0->unk_19C.z);
    ...
    if (arg0->unk_284 == 1) {
        ...
        if (arg0->unk_286 == 1) {
            arg0->acceleration.x -= (var_fs1 - (var_fa1 * arg0->unk_A8.x));
            arg0->acceleration.y -= (var_fs0 - (var_fa1 * arg0->unk_A8.y));
            arg0->acceleration.z -= (var_ft4 - (var_fa1 * arg0->unk_A8.z));
        } else {
            arg0->acceleration.x += (var_fs1 - (var_fa1 * arg0->unk_A8.x));
            arg0->acceleration.y += (var_fs0 - (var_fa1 * arg0->unk_A8.y));
            arg0->acceleration.z += (var_ft4 - (var_fa1 * arg0->unk_A8.z));
        ...
        var_ft4 = arg0->unk_1D8 * arg0->unk_C0.z.z;
        if (arg0->unk_286 == 1) {
            arg0->acceleration.x -= var_fs1;
            arg0->acceleration.y -= var_fs0;
            arg0->acceleration.z -= var_ft4;
        } else {
            arg0->acceleration.x += var_fs1;
            arg0->acceleration.y += var_fs0;
            arg0->acceleration.z += var_ft4;
    ...
    if (!(arg0->unk_04 & 0x08004000) && ((arg0->unk_04 & 0xF) != 4)) {
        sp128 = (arg0->unk_C0.z.x * arg0->velocity.x) + (arg0->unk_C0.z.y * arg0->velocity.y) +
                (arg0->unk_C0.z.z * arg0->velocity.z);
        ...
        sp128 *= var_fa1;
        arg0->velocity.x -= sp128 * arg0->unk_C0.z.x;
        arg0->velocity.y -= sp128 * arg0->unk_C0.z.y;
        arg0->velocity.z -= sp128 * arg0->unk_C0.z.z;
    ...
    if (((buttonCurrent | buttonReleased) & BTN_A) && (arg0->speed < arg0->unk_1EC)) {
        if (var_ft4 <= 0.0f) {
            var_ft4 = 0.0f;
            var_fv1 = var_fs1;
        } else {
            ...
            if (var_ft4 < var_fv1) {
                ...
                if (arg0->unk_1E8 == 0.0f) {
                    ...
                    var_fv1 = ((D_800CF174[4] - var_fs0) * arg0->unk_1E8) + var_fs0;
                }
            }
        }
    ...
    arg0->velocity.x += arg0->acceleration.x;
    arg0->velocity.y += arg0->acceleration.y;
    arg0->velocity.z += arg0->acceleration.z;
    arg0->speed = sqrtf(SQ(arg0->velocity.x) + SQ(arg0->velocity.y) + SQ(arg0->velocity.z));
    if (arg0->unk_04 & 0x80000) {
        arg0->velocity.x *= 0.94f;
        arg0->velocity.z *= 0.94f;
        arg0->unk_0C.unk_34.x += arg0->velocity.x;
        arg0->unk_0C.unk_34.y += arg0->velocity.y;
        arg0->unk_0C.unk_34.z += arg0->velocity.z;
        arg0->unk_0C.unk_28.x += arg0->velocity.x;
        arg0->unk_0C.unk_28.y += arg0->velocity.y;
        arg0->unk_0C.unk_28.z += arg0->velocity.z;
        arg0->unk_0C.unk_40 = sqrtf(SQ(arg0->unk_0C.unk_28.x) + SQ(arg0->unk_0C.unk_28.y) + SQ(arg0->unk_0C.unk_28.z));
        ...
        if (arg0->speed > 138.9f) {
            var_fa1 = 138.9f / arg0->speed;
            arg0->speed = 138.9f;
            arg0->velocity.x *= var_fa1;
            arg0->velocity.y *= var_fa1;
            arg0->velocity.z *= var_fa1;
        }
        if (arg0->id < gNumPlayers) {
            var_fa1 = 1.0f;
            i = 100;
        ...
        if (func_8009EBEC(&arg0->unk_0C, arg0->unk_0C.unk_34.x + arg0->velocity.x, arg0->unk_0C.unk_34.y + arg0->velocity.y,
                          arg0->unk_0C.unk_34.z + arg0->velocity.z, i, var_fa1) == 0) {
            sp128 = arg0->unk_244;
            ...
            if (!(arg0->unk_04 & 0x0A080000) && (D_800F5E98 < 0x28) && (gGameMode != 6)) {
                ...
                if (D_800F80BC < sp128) {
                    ...
                    if ((arg0->lap == arg0->unk_2AA + 1) && ((gTotalLapCount + 1) >= arg0->lap)) {
                        ...
                        i = arg0->raceTime -
                            (s32) ((50.0f * arg0->unk_244) / (3.0f * (gCurrentCourseRecordInfo->unk_0C - sp128)));
            ...
            if (arg0->unk_04 & 0x80000000) {
                if ((arg0->unk_0C.unk_34.x < -20000.0f) || (arg0->unk_0C.unk_34.x > 20000.0f) ||
                    ...
                    ((arg0->velocity.y < 0.0f) && (arg0->unk_0C.unk_28.y < -arg0->unk_270) &&
                     (((arg0->unk_0C.unk_28.x * arg0->velocity.x) + (arg0->unk_0C.unk_28.y * arg0->velocity.y) +
                       (arg0->unk_0C.unk_28.z * arg0->velocity.z)) >= 0.0f))) {
                    func_80090AFC(arg0);
                }
            }
        } else {
    ...
    arg0->unk_5C.x =
        (arg0->unk_C0.z.x * arg0->velocity.x) + (arg0->unk_C0.z.y * arg0->velocity.y) + (arg0->unk_C0.z.z * arg0->velocity.z);
    arg0->unk_5C.y =
        (arg0->unk_C0.y.x * arg0->velocity.x) + (arg0->unk_C0.y.y * arg0->velocity.y) + (arg0->unk_C0.y.z * arg0->velocity.z);
    arg0->unk_5C.z =
        (arg0->unk_C0.x.x * arg0->velocity.x) + (arg0->unk_C0.x.y * arg0->velocity.y) + (arg0->unk_C0.x.z * arg0->velocity.z);
    ...
    var_fa1 = SIN(arg0->unk_210) * (arg0->speed * 0.007f);
    if (arg0->unk_08 & 0x400) {
        var_fa1 *= 5.0f;
    }
    ...
    if (arg0->unk_21C != 0) {
        if (!((arg0->id + gGameFrameCount) & 3) && (arg0->unk_2B4 != 0)) {
            ...
            func_i2_80105590(sp10C.x, sp10C.y, sp10C.z, arg0->velocity.x, arg0->velocity.y, arg0->velocity.z,
            ...
            for (i = 2; i > 0; i--) {
                ...
                func_i2_80105700(sp10C.x, sp10C.y, sp10C.z,
                                 arg0->velocity.x + (var_fs1 * arg0->unk_C0.z.x) + (var_fs0 * arg0->unk_C0.y.x) +
                                     (var_ft4 * arg0->unk_C0.x.x),
                                 arg0->velocity.y + (var_fs1 * arg0->unk_C0.z.y) + (var_fs0 * arg0->unk_C0.y.y) +
                                     (var_ft4 * arg0->unk_C0.x.y),
                                 arg0->velocity.z + (var_fs1 * arg0->unk_C0.z.z) + (var_fs0 * arg0->unk_C0.y.z) +
                                     (var_ft4 * arg0->unk_C0.x.z),
                                 arg0);
            }
        }
        ...
        if (arg0->unk_21C >= 0x97) {
            ...
            func_800892E0(arg0);
            if (arg0->unk_2B4 != 0) {
                func_i2_80105648(arg0->unk_0C.unk_34.x, arg0->unk_0C.unk_34.y, arg0->unk_0C.unk_34.z, arg0->velocity.x,
                                 arg0->velocity.y, arg0->velocity.z, 80.0f, arg0);
                if (arg0->id < gNumPlayers) {
                    i = 60;
                } else {
                    i = 30;
        ...
        if (((Math_Rand1() & 0x1FFFF) < 0x444) && (arg0->unk_2B4 != 0)) {
            ...
            func_i2_801054C0(sp10C.x, sp10C.y, sp10C.z,
                             ...
                             arg0->velocity.z + (var_fs1 * arg0->unk_C0.z.z) + (var_fs0 * arg0->unk_C0.y.z) +
                                 (var_ft4 * arg0->unk_C0.x.z),
                             10.0f, arg0);
            func_i2_801058FC(sp10C.x, sp10C.y, sp10C.z, arg0->velocity.x + arg0->unk_B4.x,
                             arg0->velocity.y + arg0->unk_B4.y, arg0->velocity.z + arg0->unk_B4.z, 20.0f, arg0);
...
void func_800952F4(void) {
    ...
    for (i = 0; i < gNumPlayers; i++) {
        racer2 = &gRacers[i];
        if ((racer2->maxSpeed < racer2->speed) && !(racer2->unk_04 & 0x0E080000) && (D_800F80A8[i] == 0)) {
    ...
    if (gGameMode == GAMEMODE_TIME_ATTACK) {
        ...
        for (var_s0 = &D_800F5DF0[2]; var_s0 >= D_800F5DF0; var_s0--) {
            if ((var_s0->unk_12 != 0) && (var_s0->unk_10 != 0)) {
                ...
                racer->velocity.x = var_s0->unk_20.x - racer->unk_10C.x;
                racer->velocity.y = var_s0->unk_20.y - racer->unk_10C.y;
                racer->velocity.z = var_s0->unk_20.z - racer->unk_10C.z;
                ...
                if (func_8009EBEC(&racer->unk_0C, racer->unk_10C.x, racer->unk_10C.y, racer->unk_10C.z, 100, 1.0f) !=
                    ...
                    if (var_s0->unk_00 & 1) {
                        ...
                        if (var_s0->unk_0C >= var_s0->ghost->replaySize) {
                            var_s0->unk_10 = 0;
                    ...
                    if (var_s0->ghost->replayEnd < var_s0->unk_0C) {
