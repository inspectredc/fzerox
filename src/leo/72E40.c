...
s32 func_i1_80404204(void) {
    ...
    LeoLBAToByte(D_i1_80428638.startLBA, 3, &sp1C);
...
s32 func_i1_804045AC(void) {
    ...
    if (func_i1_804069DC(D_i1_80428638.startLBA, &D_i1_80419EA0, 3) < 0) {
        return -1;
    }
    return 0;
}
...
s32 func_i1_80404610(void) {
    if (func_i1_80406830(D_i1_80428638.startLBA, &D_i1_80419EA0, 3) < 0) {
        return -1;
    }
    return 0;
}
...
s32 func_i1_80404924(void) {
    ...
    for (i = 4; i <= (D_i1_80428638.endLBA - D_i1_80428638.startLBA); i++) {
        ...
        LeoLBAToByte(i + D_i1_80428638.startLBA, 1, &sp24);
        sp20 += sp24;
    }
...
s32 func_i1_80404B90(u16 arg0, u16 arg1, u16 arg2) {
    ...
    if ((arg0 < 4) || (D_i1_80428638.endLBA < (arg0 + D_i1_80428638.startLBA + arg1) - 1)) {
        D_i1_80428610 = 0xF4;
        return -1;
    }
    ...
    for (i = 0; i < arg1; i++) {
        if (D_i1_80428F70[D_i1_80428638.startLBA + arg0 + i] != 0) {
            D_i1_80428610 = 0x108;
            return -1;
        }
        D_i1_80428F70[D_i1_80428638.startLBA + arg0 + i] = 0xFFFD;
    }
...
s32 func_i1_80404CF0(u16 arg0, u16 arg1, u16 arg2) {
    ...
    for (i = 0; i < arg1; i++) {
        if (D_i1_80428F70[D_i1_80428638.startLBA + arg0 + i] != 0xFFFD) {
            D_i1_80428610 = 0x109;
            return -1;
        }
        D_i1_80428F70[D_i1_80428638.startLBA + arg0 + i] = 0;
    }
...
u16 func_i1_8040547C(void) {
    ...
    while (D_i1_8042A602 < D_i1_8042860C) {
        if ((D_i1_80419EA0.unk_16B0[D_i1_8042A602].unk_02 == D_i1_8042A600) &&
            ...
            return D_i1_80419EA0.unk_16B0[D_i1_8042A602++].unk_0A;
        }
        D_i1_8042A602++;
    }
...
u16 func_i1_8040555C(u16 arg0, s32 arg1) {
    ...
    return D_i1_80419EA0.unk_16B0[sp1E].unk_0A;
}
...
u16 func_i1_8040567C(u16 arg0) {
    ...
    return D_i1_80419EA0.unk_16B0[arg0].unk_02;
}
...
s32 func_i1_80405798(u16 arg0, u16 arg1) {
    ...
    sp1E = D_i1_80419EA0.unk_16B0[sp1C].unk_02;
    if (sp1E == arg1) {
        return 0;
    }
    ...
    D_i1_80419EA0.unk_16B0[sp1C].unk_02 = arg1;
    return 0;
}
...
s32 func_i1_80405C0C(u16 arg0, s32 arg1) {
    ...
    for (i = 0, sp18 = 0; i < D_i1_8042860C; i++) {
        ...
        if (D_i1_80419EA0.unk_16B0[i].unk_02 == sp1C) {
            sp18++;
        }
    }
