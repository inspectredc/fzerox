...
s32 func_i1_80409310(s32 arg0, u8* arg1, u32 arg2, s32* arg3, OSMesg* arg4, s32* arg5, s32 arg6) {
    ...
    for (sp20 = 1; sp20 <= sp24; sp20++) {
        LeoLBAToByte(arg0 + D_i1_80428638.startLBA, sp20, &sp1C);
        if (sp1C > arg2) {
            break;
        }
    }
    ...
    sp20--;
    if (sp20 > 0) {
        if (func_i1_8040A5F8(arg0 + D_i1_80428638.startLBA, arg1, sp20, arg6) < 0) {
            return -1;
        }
        LeoLBAToByte(arg0 + D_i1_80428638.startLBA, sp20, &sp1C);
    } else {
        if (func_i1_8040A5F8(arg0 + D_i1_80428638.startLBA, D_i1_80415190, 1, arg6) < 0) {
            return -1;
        }
...
s32 func_i1_804098C4(u16 arg0, u8* arg1, s32 arg2, u32 arg3) {
    ...
    if (sp3C != 0) {
        LeoLBAToByte(sp30 + D_i1_80428638.startLBA, 1, &sp34);
        if (func_i1_8040A5F8(sp30 + D_i1_80428638.startLBA, D_i1_80415190, 1, sp38) < 0) {
            return -1;
        }
    ...
    while (sp40 != 0) {
        ...
        for (sp28 = 1; sp28 <= sp2C; sp28++) {
            LeoLBAToByte(sp30 + D_i1_80428638.startLBA, sp28, &sp34);
            if (sp34 < sp40) {
                continue;
            }

            if (sp34 == sp40) {
                if (func_i1_8040A5F8(sp30 + D_i1_80428638.startLBA, sp24, sp28, sp38) < 0) {
                    return -1;
                }
                sp40 = 0;
                break;
        ...
        if (func_i1_8040A5F8(sp30 + D_i1_80428638.startLBA, sp24, sp2C, sp38) < 0) {
            return -1;
        }
        LeoLBAToByte(sp30 + D_i1_80428638.startLBA, sp2C, &sp34);
        sp40 -= sp34;
        sp24 += sp34;
        sp30 = (sp30 + sp2C) - 1;
