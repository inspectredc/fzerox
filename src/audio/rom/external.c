...
void Audio_LevelSEFadeoutRoutine(void) {
    ...
    if ((sPlayerEngineSoundState[0] != 0) && (sActivePlayerLevelSE[0][0] != NA_LEVEL_SE_NONE) &&
        (sChannelVolume[6] != 0.0f)) {
    ...
    if ((sPlayerEngineSoundState[1] != 0) && (sActivePlayerLevelSE[1][0] != NA_LEVEL_SE_NONE) &&
        (sChannelVolume[7] != 0.0f)) {
    ...
    if ((sPlayerEngineSoundState[2] != 0) && (sActivePlayerLevelSE[2][0] != NA_LEVEL_SE_NONE) &&
        (sChannelVolume[8] != 0.0f)) {
    ...
    if ((sPlayerEngineSoundState[3] != 0) && (sActivePlayerLevelSE[3][0] != NA_LEVEL_SE_NONE) &&
        (sChannelVolume[9] != 0.0f)) {
...
void func_800B899C(u8 playerIndex) {
    ...
    if ((gRacers[playerIndex].accelerationForce == 0.0f) && (gRacers[playerIndex].driftAttackForce == 0.0f)) {
        if (D_800D1A94[playerIndex] == 1) {
            ...
            vec.x = gRacers[playerIndex].segmentPositionInfo.pos.x - gCameras[playerIndex].eye.x;
            vec.y = gRacers[playerIndex].segmentPositionInfo.pos.y - gCameras[playerIndex].eye.y;
            vec.z = gRacers[playerIndex].segmentPositionInfo.pos.z - gCameras[playerIndex].eye.z;
