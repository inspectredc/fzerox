...
void Audio_SequenceChannelProcessSound(SequenceChannel* channel, bool recalculateVolume, bool applyBend) {
    f32 channelVolume;
    f32 chanFreqScale;
    s32 i;
...
f32 Audio_GetVibratoFreqScale(VibratoState* vib) {
    static f32 D_80771A60 = 0.0f;
    static s32 D_80771A64 = 0;
    f32 pitchChange;
    f32 depth;
    f32 invDepth;
    f32 result;
