...
void ExpansionKit_SetMenuHighlightAlphaChangeScale(s32);
void func_xk1_80025F98(void);
void func_xk1_800260E4(void);
void ExpansionKit_SetMenuHighlightDrawFlag(bool);
void EKWidget_SetCursorToWidget(MenuWidget*, s32*, s32*);
void EKWidget_DrawWidgets(Gfx**, MenuWidget*, s32, s32);
void EKWidget_CloseRootWidget(MenuWidget*);
void EKWidget_SetHighlightedIndex(MenuWidget*, s32*, s32*);
void EKWidget_ExecuteWidgetAction(MenuWidget*, s32*, s32*);
...
void EKFileMenu_SetFileListArrowFlashLength(s32);
void EKFileMenu_InitFileMenu(s32, s32, s32*, s32*);
Gfx* EKFileMenu_DrawFileMenu(Gfx*, s32);
...
Gfx* EKFileMenu_DrawSelectFileText(Gfx*, s32, s32);
void EKFileMenu_DrawFileSelectedConfirmText(Gfx**, s32, s32, char*, s32);
s32 EKFileMenu_GetEnableDrawConfirmText(void);
void EKFileMenu_SetFileListScroll(s32);
void EKFileMenu_SetFileCount(s32);
...
void EKFileMenu_DrawFileMenuBorder(Gfx**, s32, s32, s32, s32);
...
void ExpansionKit_DecodeStr(char*, s8*);
...
s32 EKFileMenu_LoadFiles(u8, char*);
s32 EKFileMenu_GetFileCount(void);
s32 EKFileMenu_Compare(u8*, u8*);
void EKFileMenu_QSort(s8*, s32, s32, s32 (*)(u8*, u8*));
...
void CourseEdit_DrawControlPointInfoBackground(Gfx**, s32, s32, s32, s32);
...
bool func_xk2_800EC234(EKLoadedFile*);
...
s32 CourseEdit_GetClosestControlPoint(f32);
void func_xk2_800F0FF4(void);
void func_xk2_800F12B0(void);
void CourseEdit_SetSegmentJoinError(s32, u8);
...
void CourseEdit_DrawMouseClick(Gfx**, s32, s32);
...
void CourseEdit_AddNewSegment(s32, CourseSegment);
s32 CourseEdit_GetScreenPosition(Vec3f, s32*, s32*);
void func_xk2_800EFCD0(void);
void func_xk2_800EACB0(void);
s32 CourseEdit_LoadCourseAndName(EKLoadedFile*);
s32 CourseEdit_LoadCourse(EKLoadedFile*);
...
void CourseEdit_NumToPaddedInfoEncStr(s8*, s32, s32);
...
u8 CourseEdit_GetSegmentJoinErrors(s32);
void EKFileMenu_DrawYesNoOption(Gfx** gfxP);
...
bool MachineCreate_FileListIsFileForSuperMachine(EKLoadedFile*);
...
void MachineCreate_UpdateColorSelectAInput(u8*, u8*, u8*);
void MachineCreate_FileListSetup(void);
void MachineCreate_FileSuperMachineListSetup(void);
u8 MachineCreate_FileListClearSetup(s32);
u8 MachineCreate_FileListClearSuperSetup(void);
void MachineCreate_MachineSelectPortraitInit(Object*);
void MachineCreate_MachineSelectStatsInit(void);
void MachineCreate_MachineSelectMachineInit(Object*);
void MachineCreate_MachineSelectCursorInit(void);
void MachineCreate_PortraitInit(Object*);
void MachineCreate_MachineSelectPortraitUpdate(Object*);
void MachineCreate_MachineSelectMachineUpdate(Object*);
void MachineCreate_PortraitUpdate(Object*);
